...
var models = [
  new sample.Book('1590595009',
                  ...
                  'http://ecx.images-amazon.com/images/I/615SN01X1XL._SL110_.jpg',
                  4,
                  16.49,
                  ['programming', 'manual'],
                  true),
  new sample.Book('1590593898',
                  'Joel On Software',
                  'http://ecx.images-amazon.com/images/I/51H5V6VF7ZL._SL110_.jpg',
                  3,
                  18.20,
                  ['programming', 'history'],
                  false),
  ...
  new sample.Book('0340284028',
                  'Swallowing Darkness',
                  'https://images-na.ssl-images-amazon.com/images/I/51ElalpbWoL._SL160_AA115_.jpg',
                  5,
                  25,
                  [ 'crime'],
                  false),
  ...
  new sample.Book('84823421177',
                  "Brisingr",
                  'http://ecx.images-amazon.com/images/I/21DQRW2pG%2BL._SL500_SL150_.jpg',
                  2,
                  72,
                  [ 'fantasy', 'romance'],
                  false),
  ...
  new sample.Book('84823221187',
                  ...
                  'http://ecx.images-amazon.com/images/I/41cT1D5tnVL._SL500_SL150_.jpg',
                  4,
                  24.3,
                  [ 'manual'],
                  true),
  new sample.Book('848000000',
                  "Apple Aperture 2",
                  'http://ecx.images-amazon.com/images/I/41HohF%2B-tCL._SL500_SL150_.jpg',
                  3,
                  43,
                  [ 'programming', 'manual'],
                  false),
