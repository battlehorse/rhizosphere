...
(function() {
  var Book = function(isbn, title, img, rating, price, genres, paperback) {
    this.id = isbn;
    this.isbn = isbn;
    this.title = title;
    this.img = img;
  ...
  var metamodel = {
    ...
    rating: { kind: rhizo.meta.Kind.RANGE, label: "Rating",
