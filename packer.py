...
def AddRhizoFiles(rhizo_files, dirname, names):
  ...
  Args:
    rhizo_files: A list where rhizosphere javascript files are added.
...
def main():
  ...
  rhizo_files = []
  os.path.walk(options.dir, AddRhizoFiles, rhizo_files)
